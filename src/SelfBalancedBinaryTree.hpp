#ifndef _SELFBALANCEDBINARYSEARCHTREEHPP_
#define _SELFBALANCEDBINARYSEARCHTREEHPP_
...
template<class Key>
class SelfBalancedBinarySearchTree : public BinaryTree<Key>{
 public:
  SelfBalancedBinarySearchTree(){}
  SelfBalancedBinarySearchTree(const Key& k){ BinaryTree<Key>::getRoot() = addNode(k);}
...
#endif /* _SELFBALANCEDBINARYSEARCHTREEHPP_ */